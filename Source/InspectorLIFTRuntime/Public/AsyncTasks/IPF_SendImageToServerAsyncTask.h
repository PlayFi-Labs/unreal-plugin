...
UCLASS()
class INSPECTORLIFTRUNTIME_API UIPF_SendImageToServerAsyncTask : public UIPF_BaseAsyncTask
{
    GENERATED_BODY()
...
public:
    UFUNCTION(
        BlueprintCallable, meta = (DisplayName = "LIFT Send Image To Server", BlueprintInternalUseOnly = "true", WorldContext = "WorldContextObject"),
